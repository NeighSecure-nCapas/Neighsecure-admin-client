        ...
        <>
            <section className={"flex flex-row  gap-16 h-dvh justify-center items-center"}>
                <div className={'relative w-1/2'}>
                    <img src={LoginImage} alt={"Login Image"} className={'h-dvh w-full object-cover object-center'}/>
                    <div className={'absolute flex flex-col justify-center items-center gap-4 text-2xl text-white -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2'}>
